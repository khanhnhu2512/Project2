...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 24, 2020 lúc 04:43 PM
...
INSERT INTO `product` (`id`, `name`, `image`, `price`, `content`, `create_time`, `last_updated`) VALUES
(1, 'ip12-1', 'ip12-1', 21000000, '', 16062020, 16062020),
(2, 'ip12-2', 'ip12-2', 21000000, '', 16062020, 16062020),
(3, 'ip12-3', 'ip12-3', 21000000, '', 16062020, 16062020),
(4, 'ip12-4', 'ip12-4', 21000000, '', 16062020, 16062020),
(5, 'ip12-5', 'ip12-5', 21000000, '', 16062020, 16062020);
...
(3, 'khanhnhu3', '', '', '123', 0, '0000-00-00', '0000-00-00', '0000-00-00');
