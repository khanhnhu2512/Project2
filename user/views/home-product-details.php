    ...
    <div class="container-fluid padding pad-r-6 pad-l-6">
        ...
        <div class="row pt-3">
            ...
            <div class="col-5">
                ...
                <!-- <a class="mt-3 btn btn-secondary btn-danger btn-lg btn-block" href="index.php?method=add-cart&id=<?php echo $product['id']; ?>"></a> -->
                <form method="get">
                    <input type="hidden" name="" value="method=add-cart&id=<?php echo $product['id']; ?>">
