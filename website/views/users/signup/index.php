        ...
        <form>           
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="username" onchange="validate()" placeholder="Username">
                ...
                <div class="input-group mt-4">
                    ...
                    <input type="password" class="form-control" id="password" onchange="validate()" placeholder="Password">
                ...
                <div class="input-group mt-4">
                    ...
                    <input type="password" class="form-control" id="repassword" onchange="validate()" placeholder="Repassword">
