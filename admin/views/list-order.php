                        ...
                        <tr>
                            ...
                            foreach ($_SESSION['order'] as $key => $value) {
                                ...
                                <td class="display__body-btn">
                                    <button style="width: 80px;" class="btn btn-outline-danger mr-1"><a class="btn-link" <?php echo ($value['status']==0) ? "href='index.php?method=list-order&action=accept-order&id=".$value['id_order']."'>Accept" : ">Acepted" ?> </a></button>
                                    <button class="btn btn-outline-danger"><a class="btn-link" href="index.php?method=list-order&action=delete-order&id=<?php echo $value['id_order'];?>">Delete</a></button>
                                </td>
                                <td class="btn">
