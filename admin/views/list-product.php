            ...
            <div class="col-10" style="">
                <div class="row pl-3 pt-3 justify-content-between">
                    ...
                    <div class="row align-items-center">
                        <a href="index.php?method=add-product" class="btn btn-danger  align-items-center">Add product</a>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            foreach ($product as $key => $value) {
                                ...
                                <td class="display__body-btn">
                                    <div class="btn btn-outline-danger mr-1"><a class="btn-block" href="index.php?method=edit-product&id=<?php echo $value['id']; ?>">Edit</a></div>
                                    <div class="btn btn-outline-danger"><a class="btn-block" href="index.php?method=delete-product&id=<?php echo $value['id']; ?>">Delete</a></div>
                                </td>
                        </tr>
