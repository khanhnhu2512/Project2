                ...
                <div class="row pl-3 pt-3 pb-3 text-center">
                    <table border="1px" width="100%" cellpadding="0" cellspacing="0">
                        <tr class="font-weight-bold">
                            <td class="p-1" style="">STT</td>
                            <td class="p-1" style="width: 200px">Username</td>
                            <td class="p-1" style="width: 300px">Action</td>
                            <td class="p-1" style="width: 100px">Role</td>
                            <td class="p-1" style="width: 200px">Create time</td>
                        </tr>
                        <tr>
                            <?php $i = 0;
                            foreach ($logs as $key => $value) {
                                ...
                                <td>
                                    <p class="p-0 m-0"><?php echo $value['action']; ?></p>
                                </td>
                                <td style="">
                                    <?php foreach ($user_lv as $k => $v){
                                        if($v['id_lv'] == $value['lv']){
                                            echo $v['name'];
                                        }
                                    } ?>
