    ...
    <div class="container-fluid p-0">
        ...
        <div class="menu col-2 p-0 h-auto">
            ...
            <div class="col-10" style="height: 93vh;">
                <h3 class="col pt-3">Add category</h3>
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group col">
                        <label for="name" class="col-form-label">Category's Name</label>
                        <input type="text" id="name" name="name" class="form-control w-50" placeholder="Name..." value="<?php echo (isset($_POST['submit'])) ? $_POST['name'] : ''; ?>"" required="">
                    </div>
                    <legend class=" col">Infomations</legend>
                        <table class="text-center" border="1px" width="100%" cellpadding="0" cellspacing="0">
                            <tr class="font-weight-bold">
                                <?php foreach ($category_name[0] as $v) { ?>
                                    <td class="p-1"><?php echo $v; ?></td>
                                <?php } ?>
                            </tr>
                            <tr>
                                <?php foreach ($category_name[0] as $k => $v) { ?>
                                    <td class="p-1">
                                        <input type="checkbox" name="<?php echo $k; ?>" value="1">
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
