    ...
    <div class="container-fluid p-0">
        ...
        <div class="menu col-2 p-0 h-auto">
            ...
            <div class="col-10" style="height: 93vh;">
                <div class="display">
                    <h3 class="col">Notifications</h3>
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-group col-5">
                            <label for="lv">Send to: </label>
                            <select name="lv" class="w-25">
                                <option value="0">All</option>
                                <?php foreach ($role as $k => $v) { ?>
                                    <option value="<?php echo $v['id_lv']; ?>"><?php echo $v['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group col">
                            <p class="col-form-label">Content</p>
                            <textarea required="" name="content" id="description" cols="100" rows="5"><?php echo (isset($_POST['submit'])) ? $_POST['content'] : ""; ?></textarea>
                        </div>
                        <div class="btn w-100">
