            ...
            <div class="display">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="number" id="price" name="price" class="form-control" placeholder="Price..." value="<?php echo (isset($_POST['submit'])) ? $_POST['price'] : ""; ?>">
                    </div>
                    <div class="form-group col">
                        <label for="qty" class="col-form-label">Quantity</label>
                        <input type="number" id="qty" name="qty" class="form-control" placeholder="Quantity..." value="<?php echo (isset($_POST['submit'])) ? $_POST['qty'] : ""; ?>">
                    </div>
                    <div class="form-group col">
