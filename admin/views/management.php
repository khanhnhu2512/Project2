    ...
    <div class="container-fluid p-0">
        ...
        <div class="menu col-2 p-0 h-auto">
            ...
            <div class="col-10" style="">
                <div class="display">
                    <h3 class="col">Site management</h3>
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-group col">
                            <label for="name" class="font-weight-bold col-form-label">Banner images</label>
                            <div class="col-12 pb-2 pt-3">
                                <?php if (isset($banner_img)) {
                                    foreach ($banner_img as $k => $v) { ?>
                                        <img class="col-2 p-0 w-100 mb-1" src="../library/images/image-bg/<?php echo $v['url']; ?>" alt="">
                                <?php }
                                } ?>
                            </div>
                            <div class="form-group col">
                                <label for="filesToUpload">Chọn file</label>
                                <input id="filesToUpload" type="file" name="banner_img[]" multiple="multiple" />
                            </div>
                        </div>

                        <div class="form-group col-3">
                            <label for="price" class="col-form-label font-weight-bolder">Logo Brand</label>
                            <div class="col-5 p-0 border rounded-circle">
                                <img class=" w-100 p-0 h-auto" src="../library/images/image-bg/<?php echo (isset($management)) ? $management['logo_brand'] : ''; ?>" alt="">
                            </div>
                            <div class="form-group col">
                                <label for="fileToUpload">Chọn file</label>
                                <input id="fileToUpload" type="file" name="logo_brand" />
                            </div>
                        </div>
                        <div class="form-group col-3">
                            <label for="qty" class="col-form-label font-weight-bolder">Brand name</label>
                            <input type="text" id="qty" name="name_brand" class="form-control" placeholder="Brand name" value="<?php echo (isset($management)) ? $management['name_brand'] : ''; ?>" required="">
                        </div>
                        <div class="form-group col-3">
                            <label for="price" class="col-form-label font-weight-bolder">Logo website</label>
                            <div class="col-5 p-0 border rounded-circle">
                                <img class=" w-100 p-0" src="../library/images/image-bg/<?php echo (isset($management)) ? $management['logo_website'] : ''; ?>" alt="">
                            </div>
                            <div class="form-group col">
                                <label for="fileToUpload">Chọn file</label>
                                <input id="fileToUpload" type="file" name="logo_website" />
                            </div>
                        </div>
                        <div class="form-group col-3">
                        ...
                        <div class="row p-0 justify-content-lg-between">
                            <div class="form-group col-3">
                                <label for="qty" class="col-form-label font-weight-bolder">Left</label>
                                <input type="text" id="qty" name="footer_information_left" class="form-control" placeholder="Footer information" value="<?php echo (isset($management)) ? $management['footer_information_left'] : ''; ?>" required="">
                            </div>
                            <div class="form-group col-3">
                                <label for="qty" class="col-form-label font-weight-bolder">Center</label>
                                <input type="text" id="qty" name="footer_information_center" class="form-control" placeholder="Footer information" value="<?php echo (isset($management)) ? $management['footer_information_center'] : ''; ?>" required="">
                            </div>
                            <div class="form-group col-3">
                                <label for="qty" class="col-form-label font-weight-bolder">Right</label>
                                <input type="text" id="qty" name="footer_information_right" class="form-control" placeholder="Footer information" value="<?php echo (isset($management)) ? $management['footer_information_right'] : ''; ?>" required="">
                            </div>
                            <div class="form-group col-6 m-auto pb-3">
                                <label for="qty" class="col-form-label font-weight-bolder">Bottom</label>
                                <input type="text" id="qty" name="footer_information_bottom" class="form-control" placeholder="Footer information" value="<?php echo (isset($management)) ? $management['footer_information_bottom'] : ''; ?>" required="">
                            </div>
                        </div>
                        <div class="btn w-100">
